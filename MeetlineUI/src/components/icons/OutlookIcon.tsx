    ...
    <defs>
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(12.54902%,65.490196%,98.039216%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.4}
          style={{
            stopColor: 'rgb(23.137255%,83.529412%,100%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={1}
          style={{
            stopColor: 'rgb(76.862745%,69.019608%,100%)',
            stopOpacity: 1,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(8.627451%,35.294118%,85.098039%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.5008}
          style={{
            stopColor: 'rgb(9.411765%,50.196078%,89.803922%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={1}
          style={{
            stopColor: 'rgb(52.156863%,52.941176%,100%)',
            stopOpacity: 1,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0.236946}
          style={{
            stopColor: 'rgb(26.666667%,54.117647%,100%)',
            stopOpacity: 0,
          }}
        />
        <stop
          offset={0.792113}
          style={{
            stopColor: 'rgb(0%,19.607843%,69.411765%)',
            stopOpacity: 0.2,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(10.196078%,26.27451%,65.098039%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.492267}
          style={{
            stopColor: 'rgb(12.54902%,32.156863%,79.607843%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={1}
          style={{
            stopColor: 'rgb(37.254902%,12.54902%,79.607843%)',
            stopOpacity: 1,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(0%,27.058824%,72.54902%)',
            stopOpacity: 0,
          }}
        />
        <stop
          offset={0.669859}
          style={{
            stopColor: 'rgb(5.098039%,12.156863%,41.176471%)',
            stopOpacity: 0.2,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0.568182}
          style={{
            stopColor: 'rgb(15.294118%,37.254902%,94.117647%)',
            stopOpacity: 0,
          }}
        />
        <stop
          offset={0.992424}
          style={{
            stopColor: 'rgb(0%,12.941176%,46.666667%)',
            stopOpacity: 1,
          }}
        />
      </radialGradient>
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(30.196078%,76.862745%,100%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.196145}
          style={{
            stopColor: 'rgb(5.882353%,68.627451%,100%)',
            stopOpacity: 1,
          }}
        />
      </linearGradient>
      ...
      >
        <stop
          offset={0.259477}
          style={{
            stopColor: 'rgb(0%,37.647059%,81.960784%)',
            stopOpacity: 0.4,
          }}
        />
        <stop
          offset={0.908166}
          style={{
            stopColor: 'rgb(1.176471%,51.372549%,94.509804%)',
            stopOpacity: 0,
          }}
        />
      </radialGradient>
      ...
      >
        <stop
          offset={0.732317}
          style={{
            stopColor: 'rgb(95.686275%,65.490196%,96.862745%)',
            stopOpacity: 0,
          }}
        />
        <stop
      ...
      >
        <stop
          offset={0}
          style={{
            stopColor: 'rgb(28.627451%,87.058824%,100%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.724349}
          style={{
            stopColor: 'rgb(16.078431%,76.470588%,100%)',
            stopOpacity: 1,
          }}
        />
      </radialGradient>
      ...
      >
        <stop
          offset={0.205882}
          style={{
            stopColor: 'rgb(42.352941%,87.843137%,100%)',
            stopOpacity: 1,
          }}
        />
        <stop
          offset={0.535}
          style={{
            stopColor: 'rgb(31.372549%,83.529412%,100%)',
            stopOpacity: 0,
          }}
        />
      </linearGradient>
      ...
      >
        ...
        <stop
          offset={0.919119}
          style={{
            stopColor: 'rgb(9.411765%,23.921569%,67.843137%)',
            stopOpacity: 1,
          }}
        />
      </radialGradient>
      ...
      >
        <stop
          offset={0.557796}
          style={{
            stopColor: 'rgb(5.882353%,64.705882%,96.862745%)',
            stopOpacity: 0,
          }}
        />
        <stop
          offset={1}
          style={{
            stopColor: 'rgb(45.490196%,77.647059%,100%)',
            stopOpacity: 0.501961,
          }}
        />
      </radialGradient>
