...
import type { CreateRoleData, CreateRoleResponses, EmailAvailabilityData, EmailAvailabilityResponses, GetApiDebugEndpointsData, GetApiDebugEndpointsResponses, GetCurrentUserData, GetCurrentUserResponses, GetRoleByIdData, GetRoleByIdErrors, GetRoleByIdResponses, GetRolesData, GetRolesResponses, GetUserByIdData, GetUserByIdErrors, GetUserByIdResponses, OnboardUserData, OnboardUserErrors, OnboardUserResponses, PostApiWebhooksClerkData, PostApiWebhooksClerkResponses, UsernameAvailabilityData, UsernameAvailabilityResponses } from './types.gen';
...
export const getApiDebugEndpoints = <ThrowOnError extends boolean = false>(options?: Options<GetApiDebugEndpointsData, ThrowOnError>) => (options?.client ?? client).get<GetApiDebugEndpointsResponses, unknown, ThrowOnError>({
 ...
 */
export const onboardUser = <ThrowOnError extends boolean = false>(options: Options<OnboardUserData, ThrowOnError>) => (options.client ?? client).post<OnboardUserResponses, OnboardUserErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const usernameAvailability = <ThrowOnError extends boolean = false>(options: Options<UsernameAvailabilityData, ThrowOnError>) => (options.client ?? client).get<UsernameAvailabilityResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const emailAvailability = <ThrowOnError extends boolean = false>(options: Options<EmailAvailabilityData, ThrowOnError>) => (options.client ?? client).get<EmailAvailabilityResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const postApiWebhooksClerk = <ThrowOnError extends boolean = false>(options?: Options<PostApiWebhooksClerkData, ThrowOnError>) => (options?.client ?? client).post<PostApiWebhooksClerkResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
